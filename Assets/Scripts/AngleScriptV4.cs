...
public class HumanoidCalculatorv4 : MonoBehaviour
{
    ...
    public class DistanceCalculator
    {
        ...
        public DistanceCalculator(string name, Transform jointA, Transform jointB, Transform jointC, float minDistance)
        {
            this.name = name;
            this.jointA = jointA;
            this.jointB = jointB;
        ...
        public float CalculateDistance()
        {
            ...
            {
                return ((jointA.position.z+jointC.position.z)/2 - jointB.position.z);
            }
            return 0f;
        }
